...
Route::middleware(['auth', 'checkAdmin'])->group(function () {
    ...
    Route::name('admin.categories.')->group(function () {
        ...
        Route::get('/admin/categories/stats', [AdminCategoryController::class, 'getStats'])->name('stats');
    ...
    Route::name('admin.products.')->group(function () {
        ...
        Route::get('/admin/products/stats', [AdminProductController::class, 'getStats'])->name('stats');
    ...
    Route::name('admin.orders.')->group(function () {
        Route::patch('admin/orders/{order}', [OrderController::class, 'update'])->name('update');
        Route::get('/admin/orders/data', [OrderController::class, 'data'])->name('data');
    ...
    Route::name('admin.users.')->group(function () {
        ...
        Route::get('/admin/users/stats', [AdminUserController::class, 'getStats'])->name('stats');
