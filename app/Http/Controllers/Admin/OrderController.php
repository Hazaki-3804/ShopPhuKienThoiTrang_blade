        ...
        try {
            ...
            return DataTables::of($query)
                ...
                ->addColumn('order_info', function ($order) {
                    $customerName = $order->user ? $order->user->name : 'Khách vãng lai';
                ...
                ->addColumn('actions', function ($order) {
                    ...
                    $editButton = '<button type="button" class="btn btn-sm btn-outline-warning edit-order" style="margin-right:6px" 
                        data-toggle="modal" data-target="#updateStatusModal" data-id="' . $order->id . '" title="Cập nhật trạng thái">
                ...
                ->rawColumns(['order_info', 'total_formatted', 'status_badge', 'payment_method', 'created_date', 'actions'])
                ->make(true);
        } catch (\Exception $e) {
