                    ...
                    <form method="POST" action="{{ route('register.post') }}" novalidate>
                        ...
                        <div class="row g-3">
                            <div class="col-12 col-md-6">
                                <label for="name" class="form-label label-input-important">Họ và tên</label>
                            ...
                            <div class="col-12 col-md-6">
                                <label for="email" class="form-label label-input-important">Email</label>
                            ...
                            <div class="col-12 col-md-6">
                                <label for="phone" class="form-label label-input-important">Số điện thoại</label>
                            ...
                            <div class="col-12">
                                <label for="address" class="form-label label-input-important">Địa chỉ</label>
                                <div class="row">
                            ...
                            <div class="col-12">
                                <label for="address" class="form-label label-input-important">Địa chỉ chi tiết</label>
                            ...
                            <div class="col-12 col-md-6">
                                <label for="password" class="form-label label-input-important">Mật khẩu</label>
                            ...
                            <div class="col-12 col-md-6">
                                <label for="password_confirmation" class="form-label label-input-important">Xác nhận mật khẩu</label>
