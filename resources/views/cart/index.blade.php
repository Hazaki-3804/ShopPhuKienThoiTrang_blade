...
@push('styles')
<style>
    .cart-thumb { width: 64px; height: 64px; object-fit: cover; }
    @media (min-width: 992px) { .cart-thumb { width: 72px; height: 72px; } }
    /* Shopee-like delete button */
    .btn-delete-shopee { background: #fff; color: #EE4D2D; border: 1px solid #EE4D2D; }
    .btn-delete-shopee:hover, .btn-delete-shopee:focus { background: #EE4D2D; color: #fff; border-color: #EE4D2D; }
</style>
@endpush
@push('scripts')
<script>
